...
if (Config.WORKTYPE == 'private') {
    ...
    WhatsAlexa.addCommand({ pattern: 'ttp ?(.*)', fromMe: true, desc: Lang.TTP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, contextInfo: { forwardingScore: 5, isForwarded: true }, quoted: message.data, caption: '*Made by WhatsAlexa*' })
    ...
    WhatsAlexa.addCommand({ pattern: 'attp ?(.*)', fromMe: true, desc: Lang.ATTP_DESC }, (async (message, match) => {
        ...
        await message.client.sendMessage(message.jid,Buffer.from(ttinullimage.data), MessageType.sticker, { mimetype: Mimetype.webp, contextInfo: { forwardingScore: 5, isForwarded: true }, quoted: message.data })
