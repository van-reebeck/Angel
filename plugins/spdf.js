...
if (Config.WORKTYPE == 'private') {
    ...
    if (match[1] === '') return await message.client.sendMessage(message.jid, Lang.SPDF_LINK, MessageType.text, {contextInfo: { forwardingScore: 1000, isForwarded: true }})
    ...
    await message.client.sendMessage(message.jid, Lang.SPDF_PROC, MessageType.text, {contextInfo: { forwardingScore: 1000, isForwarded: true }})
    ...
    if (match[1] === '') return await message.sendMessage(message.jid, Lang.SPDF_LINK, MessageType.text, {contextInfo: { forwardingScore: 1000, isForwarded: true }})

    var webimage = await axios.get(`https://api.html2pdf.app/v1/generate?url=${match[1]}&apiKey=begC4dFAup1b8LyRXxAfjetfqDg2uYx8PWmh9YJ59tTZXiUyh2Vs72HdYQB68vyc`, { responseType: 'arraybuffer' })

    await message.sendMessage(message.jid, Lang.SPDF_PROC, MessageType.text, {contextInfo: { forwardingScore: 1000, isForwarded: true }})
